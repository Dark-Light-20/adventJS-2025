...
| #2        |                               | ⚪️ Unknow | [Description](challenges/02.md) | [JS Solution](solutions/js/02.js) | [TS Solution](solutions/ts/02.ts) | [Py Solution](solutions/python/02.py) |
...
| #9        |                               | ⚪️ Unknow | [Description](challenges/09.md) | [JS Solution](solutions/js/09.js) | [TS Solution](solutions/ts/09.ts) | [Py Solution](solutions/python/09.py) |
| #10       |                               | ⚪️ Unknow | [Description](challenges/10.md) | [JS Solution](solutions/js/10.js) | [TS Solution](solutions/ts/10.ts) | [Py Solution](solutions/python/10.py) |
...
To run the solutions, you need to have Node.js (v22+ LTS) installed on your machine (or Python3). Once you have Node.js (or Python3) installed, clone this repository, install the dependencies and run each solution `.js` or `.ts` (or `.py`) file.

## Usage

Each challenge is contained in its own _instructions_.md file and its own _solution_.js file. You can run a specific challenge by using Node.js to execute the file for `.js` files, tsx to execute the file for `.ts` files or python3 to execute the file for `.py` files. For example, to run Challenge 1, you would use the following command:
